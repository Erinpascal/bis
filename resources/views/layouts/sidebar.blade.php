  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('customers.index') }}"><i class="fa fa-user fa-lg"></i> <span> Customer </span></a></li>
        <!-- <li class="treeview">
        ...
        <li><a href="{{ route('goods.index') }}"><i class="fa fa-user fa-lg"></i> <span> Goods </span></a></li>
